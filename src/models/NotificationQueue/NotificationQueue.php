...
class NotificationQueue extends ActiveRecord implements NotificationQueueInterface
{
    ...
    public function __construct($user_id, NotificationInterface $notification)
    {
        $this->id = new Id();
    ...
    public function beforeSave($insert)
    {
        ...
        $this->setAttribute('read_at', $this->read_at->getValue());
        ...
        $this->setAttribute('message_class', $this->message_class->getValue());
        $this->setAttribute('message_data', $this->message_data->getValue());
